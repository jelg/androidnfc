...
def:custom_masthead() ?>
  <div id="header">
      <div id="headerLeft">
          <a href="<?cs var:toroot ?>index.html" tabindex="-1"><img align="middle"
              src="<?cs var:toroot ?>assets/Open-NFC_large.jpg" alt="Open NFC" /></a><span class="headtext" style="vertical-align: middle;">Open NFC API for Android</span>
